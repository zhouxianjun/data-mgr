...
public class RoleStruct implements org.apache.thrift.TBase<RoleStruct, RoleStruct._Fields>, java.io.Serializable, Cloneable, Comparable<RoleStruct> {
  ...
  private static final org.apache.thrift.protocol.TField PNAME_FIELD_DESC = new org.apache.thrift.protocol.TField("pname", org.apache.thrift.protocol.TType.STRING, (short)4);
  private static final org.apache.thrift.protocol.TField CREATE_DATE_FIELD_DESC = new org.apache.thrift.protocol.TField("create_date", org.apache.thrift.protocol.TType.I64, (short)5);
  private static final org.apache.thrift.protocol.TField UPDATE_DATE_FIELD_DESC = new org.apache.thrift.protocol.TField("update_date", org.apache.thrift.protocol.TType.I64, (short)6);
  ...
  private String pname; // required
  private long create_date; // required
  private long update_date; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    PID((short)3, "pid"),
    PNAME((short)4, "pname"),
    CREATE_DATE((short)5, "create_date"),
    UPDATE_DATE((short)6, "update_date"),
  ...
  private static final int __CREATE_DATE_ISSET_ID = 2;
  private static final int __UPDATE_DATE_ISSET_ID = 3;
  ...
  static {
    ...
    tmpMap.put(_Fields.PNAME, new org.apache.thrift.meta_data.FieldMetaData("pname", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.STRING)));
    tmpMap.put(_Fields.CREATE_DATE, new org.apache.thrift.meta_data.FieldMetaData("create_date", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)));
    tmpMap.put(_Fields.UPDATE_DATE, new org.apache.thrift.meta_data.FieldMetaData("update_date", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)));
    ...
    boolean status)
  {
    ...
    setCreate_dateIsSet(true);
    this.update_date = update_date;
    setUpdate_dateIsSet(true);
    this.status = status;
    setStatusIsSet(true);
  }
  ...
  public void clear() {
    ...
    this.pid = 0;
    this.pname = null;
    setCreate_dateIsSet(false);
    this.create_date = 0;
    setUpdate_dateIsSet(false);
    this.update_date = 0;
  ...
  public RoleStruct setPname(String pname) {
    this.pname = pname;
    return this;
  }
  ...
  public RoleStruct setCreate_date(long create_date) {
    this.create_date = create_date;
    setCreate_dateIsSet(true);
    return this;
  }
  ...
  public void unsetCreate_date() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __CREATE_DATE_ISSET_ID);
  }

  /** Returns true if field create_date is set (has been assigned a value) and false otherwise */
  public boolean isSetCreate_date() {
    return EncodingUtils.testBit(__isset_bitfield, __CREATE_DATE_ISSET_ID);
  }

  public void setCreate_dateIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __CREATE_DATE_ISSET_ID, value);
  }
  ...
  public RoleStruct setUpdate_date(long update_date) {
    this.update_date = update_date;
    setUpdate_dateIsSet(true);
    return this;
  }

  public void unsetUpdate_date() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __UPDATE_DATE_ISSET_ID);
  }

  /** Returns true if field update_date is set (has been assigned a value) and false otherwise */
  public boolean isSetUpdate_date() {
    return EncodingUtils.testBit(__isset_bitfield, __UPDATE_DATE_ISSET_ID);
  }

  public void setUpdate_dateIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __UPDATE_DATE_ISSET_ID, value);
  }
  ...
  public boolean equals(RoleStruct that) {
    ...
    boolean this_present_create_date = true;
    boolean that_present_create_date = true;
    if (this_present_create_date || that_present_create_date) {
      if (!(this_present_create_date && that_present_create_date))
        return false;
      if (this.create_date != that.create_date)
        return false;
    }

    boolean this_present_update_date = true;
    boolean that_present_update_date = true;
    if (this_present_update_date || that_present_update_date) {
      if (!(this_present_update_date && that_present_update_date))
        return false;
      if (this.update_date != that.update_date)
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_create_date = true;
    list.add(present_create_date);
    if (present_create_date)
      list.add(create_date);

    boolean present_update_date = true;
    list.add(present_update_date);
    if (present_update_date)
  ...
  public int compareTo(RoleStruct other) {
    ...
    lastComparison = Boolean.valueOf(isSetCreate_date()).compareTo(other.isSetCreate_date());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetCreate_date()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.create_date, other.create_date);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetUpdate_date()).compareTo(other.isSetUpdate_date());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetUpdate_date()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.update_date, other.update_date);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  private static class RoleStructStandardScheme extends StandardScheme<RoleStruct> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, RoleStruct struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 5: // CREATE_DATE
            if (schemeField.type == org.apache.thrift.protocol.TType.I64) {
              struct.create_date = iprot.readI64();
              struct.setCreate_dateIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
          case 6: // UPDATE_DATE
            if (schemeField.type == org.apache.thrift.protocol.TType.I64) {
              struct.update_date = iprot.readI64();
              struct.setUpdate_dateIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, RoleStruct struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI64(struct.create_date);
      oprot.writeFieldEnd();
      oprot.writeFieldBegin(UPDATE_DATE_FIELD_DESC);
      oprot.writeI64(struct.update_date);
      oprot.writeFieldEnd();
  ...
  private static class RoleStructTupleScheme extends TupleScheme<RoleStruct> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, RoleStruct struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetCreate_date()) {
        optionals.set(4);
      }
      if (struct.isSetUpdate_date()) {
        optionals.set(5);
      }
